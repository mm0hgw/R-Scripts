...
runTest <- function(testData) {
    print(microbenchmark::microbenchmark(swapHalves(seq(testData)), swapHalves2(seq(testData))))
    print(microbenchmark::microbenchmark(swapHalves(seq(testData+1)), swapHalves2(seq(testData+1))))
}
